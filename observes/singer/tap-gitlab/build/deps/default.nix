{
  ...
  pure-requests = import ./pure_requests.nix {
    inherit fa-purity nixpkgs python_version;
  };
  ...
  layer_1 = python_pkgs:
    ...
    // {
      ...
      pure-requests = pure-requests.pkg;
