...
export const SmallScreenLogin: React.FC = (): JSX.Element => {
  ...
  return (
    <Container display={"flex"} width={"100%"} wrap={"wrap"}>
      ...
      <Container bgColor={"#25252d"} display={"flex"} wrap={"wrap"}>
        <Container
          align={"end"}
          display={"flex"}
          height={`${height}px`}
        ...
        >
          <Container display={"flex"} wrap={"wrap"}>
            <Container height={"70px"} pb={"15px"} pt={"15px"}>
              <Tag variant={"redNoBd"}>
                <Container
                  height={"20px"}
                  heightMd={"20px"}
            ...
            <Container pt={"24px"} ptMd={"0px"} width={"100%"}>
              <Text
                bright={0}
                fontSize={"24px"}
                fw={9}
                ...
                (benefit: IBenefits): JSX.Element => (
                  ...
                  >
                    <Container letterSpacing={"1.2px"} pr={"16px"}>
                      <FontAwesomeIcon color={"#dddde3"} icon={benefit.icon} />
                    </Container>
                    <Container
                      lineHeight={"21px"}
                      maxWidth={"522px"}
