...
const ContinuousHackingTools: React.FC = (): JSX.Element => {
  ...
  return (
    ...
    >
      ...
      >
        <CloudImage
          alt={"tools-image"}
          src={"airs/services/continuous-hacking/tools/order.png"}
        />
        <Grid columns={4} gap={"5rem"} pv={"60px"}>
          <Container>
            <Title
              color={"#2e2e38"}
              level={2}
            ...
            <Container align={"center"} display={"flex"} mv={4}>
              ...
              <Container display={"flex"} wrap={"wrap"}>
                <Text color={"#25252d"} display={"inline-block"} size={"big"}>
