...
def reader(args: SyntaxGraphArgs) -> NId:
    left_id = args.ast_graph.nodes[args.n_id]["label_field_lhs"]
    right_id = args.ast_graph.nodes[args.n_id]["label_field_rhs"]
    operator_id = args.ast_graph.nodes[args.n_id]["label_field_op"]
