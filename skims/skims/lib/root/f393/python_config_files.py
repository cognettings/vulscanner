...
def get_method_requirements(
    ...
    for req_node in requirements_nodes:
        ...
        if node_attrs["expression"] != "self.tool_requires":
            continue
...
def conan_conanfile_py_dev(
    ...
    method = MethodsEnum.CONAN_CONANFILE_PY_DEV
    with open(
